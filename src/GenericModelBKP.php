...
abstract class GenericModelBKP extends Model implements CastsAttributes, GenericCastsAttributes, GenericCastsInboundAttributes
{
...
class_alias(GenericModel::class, 'ArtisanBR\GenericModel\Model');
